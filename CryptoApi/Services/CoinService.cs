...
public class CoinService : ICoinService
{
    ...
    private static readonly List<Coin> MockCoins = new()
    {
        ...
        new Coin { Id = "shiba-inu",         Name = "Shiba Inu",        Symbol = "SHIB",  IconClass = "shib",  Rank = 33, Price =  0.0026m, Change24h = -2.87m, MarketCap = "$1.5B",  MarketCapRaw =     1_500_000_000m, Volume = "$98M",   VolumeRaw =      98_000_000m },
