...
public class CoinService : ICoinService
{
    ...
    private static readonly List<Coin> MockCoins = new()
    {
        ...
        new Coin { Id = "near",              Name = "NEAR Protocol",    Symbol = "NEAR",  IconClass = "near",  Rank = 29, Price =     8.54m, Change24h = -3.45m, MarketCap = "$9.2B",  MarketCapRaw =     9_200_000_000m, Volume = "$310M",  VolumeRaw =     310_000_000m },
        new Coin { Id = "aave",              Name = "Aave",             Symbol = "AAVE",  IconClass = "aave",  Rank = 30, Price =   265.40m, Change24h = -5.12m, MarketCap = "$3.9B",  MarketCapRaw =     3_900_000_000m, Volume = "$185M",  VolumeRaw =     185_000_000m },
        new Coin { Id = "stellar",           Name = "Stellar",          Symbol = "XLM",   IconClass = "xlm",   Rank = 31, Price =     0.13m, Change24h = -1.89m, MarketCap = "$3.7B",  MarketCapRaw =     3_700_000_000m, Volume = "$145M",  VolumeRaw =     145_000_000m },
        new Coin { Id = "optimism",          Name = "Optimism",         Symbol = "OP",    IconClass = "op",    Rank = 32, Price =     2.09m, Change24h = -4.23m, MarketCap = "$2.8B",  MarketCapRaw =     2_800_000_000m, Volume = "$220M",  VolumeRaw =     220_000_000m },
        new Coin { Id = "shiba-inu",         Name = "Shiba Inu",        Symbol = "SHIB",  IconClass = "shib",  Rank = 33, Price =  0.000026m, Change24h = -2.87m, MarketCap = "$1.5B",  MarketCapRaw =     1_500_000_000m, Volume = "$98M",   VolumeRaw =      98_000_000m },
        new Coin { Id = "injective",         Name = "Injective",        Symbol = "INJ",   IconClass = "inj",   Rank = 34, Price =    28.50m, Change24h =  7.34m, MarketCap = "$2.4B",  MarketCapRaw =     2_400_000_000m, Volume = "$176M",  VolumeRaw =     176_000_000m },
        new Coin { Id = "arbitrum",          Name = "Arbitrum",         Symbol = "ARB",   IconClass = "arb",   Rank = 35, Price =     1.18m, Change24h =  4.56m, MarketCap = "$1.5B",  MarketCapRaw =     1_500_000_000m, Volume = "$134M",  VolumeRaw =     134_000_000m },
        new Coin { Id = "aptos",             Name = "Aptos",            Symbol = "APT",   IconClass = "apt",   Rank = 36, Price =     9.85m, Change24h =  2.11m, MarketCap = "$2.1B",  MarketCapRaw =     2_100_000_000m, Volume = "$112M",  VolumeRaw =     112_000_000m },
    };
