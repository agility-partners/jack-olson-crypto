...
internal static class CoinCatalog
{
    ...
    [
        ...
        new() { Id = "polygon",           Name = "Polygon",           Symbol = "MATIC", IconClass = "matic", Rank = 16, Price =     0.92m, Change24h = -1.23m, MarketCap = "$9.8B",  MarketCapRaw =     9_800_000_000m, Volume = "$340M",  VolumeRaw =     340_000_000m },
        ...
        new() { Id = "shiba-inu",         Name = "Shiba Inu",         Symbol = "SHIB",  IconClass = "shib",  Rank = 33, Price =   0.0026m, Change24h = -2.87m, MarketCap = "$1.5B",  MarketCapRaw =     1_500_000_000m, Volume = "$98M",   VolumeRaw =      98_000_000m },
