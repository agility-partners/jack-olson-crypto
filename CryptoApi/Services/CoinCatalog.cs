...
internal static class CoinCatalog
{
    ...
    [
        ...
        new() { Id = "maker",             Name = "Maker",             Symbol = "MKR",   IconClass = "mkr",   Rank = 43, Price =  1850.00m, Change24h = -2.14m, MarketCap = "$1.7B",   MarketCapRaw =     1_700_000_000m, Volume = "$88M",   VolumeRaw =      88_000_000m },
