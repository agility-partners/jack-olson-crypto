...
internal static class CoinCatalog
{
    ...
    [
        ...
        new() { Id = "matic-network",     Name = "Polygon",           Symbol = "MATIC", IconClass = "matic", Rank = 61, Price =     0.620m, Change24h =  1.45m, MarketCap = "$0.61B",  MarketCapRaw =       610_000_000m, Volume = "$215M",  VolumeRaw =     215_000_000m },
        ...
        new() { Id = "fantom",            Name = "Fantom",            Symbol = "FTM",   IconClass = "ftm",   Rank = 63, Price =     0.520m, Change24h =  2.18m, MarketCap = "$1.45B",  MarketCapRaw =     1_450_000_000m, Volume = "$148M",  VolumeRaw =     148_000_000m },
